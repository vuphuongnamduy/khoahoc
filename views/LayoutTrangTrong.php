...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v11.0" nonce="6ZXTskPM"></script>
    ...
    <nav class="navbar navbar-expand-md bg-white navbar-light">
        <div class="container">
            <!-- logo  -->
            <a class="navbar-brand" href="index.php" style="color: #CF111A;">TRADING</a>
            <!-- navbar-toggler  -->
                ...
                <div class="col-lg-3 col-md-5">
                    <div class="categoryheader">
                        <div class="noidungheader text-white">
                            ...
                            <span class="text-uppercase font-weight-bold ml-1">Danh mục khóa học</span>
                        </div>
                        <!-- CATEGORIES -->
                ...
                <div class="col-md-5 ml-auto contact d-none d-md-block">
                    <div class="benphai float-right">
                        <div class="hotline">
                            ...
                            <a href="index.php?controller=orders"><span>Đơn hàng <b>đã mua</b> </span></a>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        ...
                        <div class="noidung">
                            <h6 class="tieude font-weight-bold">RẤT NHIỀU KHÓA HỌC HAY ĐƯỢC ĐÁNH GIÁ CAO</h6>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        ...
                        <div class="noidung">
                            <h6 class="tieude font-weight-bold">THANH TOÁN TRỰC TUYẾN</h6>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        ...
                        <div class="noidung">
                            <h6 class="tieude font-weight-bold">TÀI LIỆU MIỄN PHÍ</h6>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        ...
                        <div class="noidung">
                            <h6 class="tieude font-weight-bold">BẢO HÀNH 12 THÁNG</h6>
